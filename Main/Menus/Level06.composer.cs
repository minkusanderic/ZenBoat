...
namespace Menu
{
    partial class Level06
    {
        ...
        private void InitializeWidget(LayoutOrientation orientation)
        {
            ...
            // Button_1
            Button_1.IconImage = new ImageAsset("/Application/assets/021.jpg");

            // Button_2
            Button_2.IconImage = new ImageAsset("/Application/assets/022.jpg");

            // Button_3
            Button_3.IconImage = new ImageAsset("/Application/assets/023.jpg");

            // Button_4
            Button_4.IconImage = new ImageAsset("/Application/assets/024.jpg");
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                ...
                default:
                    ...
                    LevelLabel_1.SetPosition(103, 506);
                    LevelLabel_1.SetSize(214, 36);
                    LevelLabel_1.Anchors = Anchors.None;
                    LevelLabel_1.Visible = true;

                    LevelLabel_2.SetPosition(447, 506);
                    LevelLabel_2.SetSize(214, 36);
                    LevelLabel_2.Anchors = Anchors.None;
                    LevelLabel_2.Visible = true;

                    LevelLabel_3.SetPosition(94, 599);
                    LevelLabel_3.SetSize(214, 36);
                    LevelLabel_3.Anchors = Anchors.None;
                    LevelLabel_3.Visible = true;

                    LevelLabel_4.SetPosition(447, 593);
                    LevelLabel_4.SetSize(214, 36);
                    LevelLabel_4.Anchors = Anchors.None;
                    LevelLabel_4.Visible = true;
        ...
        {
            Label_1.Text = "Level 21";

            Label_2.Text = "Level 22";

            Label_3.Text = "Level 23";

            Label_4.Text = "Level 24";

            LevelLabel_1.Text = "021";

            LevelLabel_2.Text = "022";

            LevelLabel_3.Text = "023";

            LevelLabel_4.Text = "024";
        }
