...
namespace Main
{
	public class MTYellowOrangeSouth
	{
		public MTYellowOrangeSouth ()
		{
		}
		public static void create(Entity ent, Dictionary<String, String> options)
		{
			...
			ModelComponent m = ent.attachComponent(new ModelComponent("/Application/assets/OrangeYellowS.mdx"));
			m.layer = "trees";
